  ...
  <section id="appointment" class="appointment section-bg">
    <div class="container">
      ...
      <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
        ...
        ?>
            <!--<div class="text-center"><a href="patient/request-appointment.php" class="appointment-btn" style="font-size:23px;"><span class="d-none d-md-inline"></span>Programar Cita</a></div>-->
          <?php
          }
        } else {
          ?>
